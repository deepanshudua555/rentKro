...
To run the project locally and experience the skills developed in Deepanshu Dua's full-stack training, follow these steps:
...
**First, download the project to your local machine by cloning it from GitHub:**
   ...
   ```
   git clone  https://github.com/deepanshudua555/rentKro.git
   ```
#### Server Side Installation
**1. Open the terminal and navigate to the project directory:**
```
  cd rentKro/server/pair-3
   ```
...
("rentKro.exception.rental.notfound",
